...
Page({
  ...
  shareImage: function() {
    wx.navigateTo({
      url: '../share/index?height=' + this.data.height + '&weight=' + this.data.weight + '&hair=' + this.data.hair + '&hairColor=' + this.data.hairColor + '&eyes=' + this.data.eyes + '&attribute=' + this.data.attribute + '&character=' + this.data.character + '&cup=' + this.data.cup + '&skin=' + this.data.skin
    })
  }
})